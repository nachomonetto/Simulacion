...
namespace Banco
{
    public partial class Form1 : Form
    {
        ...
        private void txtBoxA_KeyPress(object sender, KeyPressEventArgs e)
       {
        ...
        {
            if (txtBoxA.Text=="" || txtBoxB.Text=="" || txtBoxFrecuencia.Text=="" || txtBoxMedia.Text=="" || txtBoxSimular.Text=="" || txtBoxDesde.Text=="")
            {
            ...
            {
                //if (Convert.ToInt32(txtBoxFrecuencia.Text)<100000 || Convert.ToDecimal(txtBoxMedia.Text)<100000 || Convert.ToDecimal(txtBoxA.Text) < 100000 || Convert.ToDecimal(txtBoxB.Text) < 100000 || Convert.ToDecimal(txtBoxSimular.Text) < 100000 || Convert.ToDecimal(txtBoxDesde.Text) < 100000)
                //{
                try
                {
                    if (Convert.ToDecimal(txtBoxA.Text) < Convert.ToDecimal(txtBoxB.Text))
                    {
                        ...
                        if (Math.Round(Convert.ToDecimal(txtBoxDesde.Text), 2) < Math.Round(Convert.ToDecimal(txtBoxSimular.Text), 2))
                        {
                            if (Convert.ToInt16(txtBoxFrecuencia.Text) != 0)
                            {
                                if (Convert.ToDecimal(txtBoxMedia.Text) != 0)
                                {
                                    ...
                                    {
                                        if (Convert.ToDecimal(row.Cells[0].Value) < Convert.ToDecimal(txtBoxDesde.Text))
                                        {
                                            contadorDeFilas++;
                                        }
                                    }
                                    ...
                                    {
                                        for (int i = 0; i < contadorDeFilas; i++)
                                        {
                                            dgv.Rows.RemoveAt(0);
                                        }
                                    }
                                    if (dgv.Rows.Count == 0)
                                    {
                                        MessageBox.Show("No se encontraron filas que coincidan con el rango especificado");
                                    }
                                }
                                else
                                {
                                    MessageBox.Show("Algunos valores no pueden ser 0");
                                }
                        ...
                        {
                            MessageBox.Show("El parámetro Desde debe ser menor al parámetro Hasta");
                        }
                ...
                {
                    MessageBox.Show("Uno o más campos contienen números muy grandes. Pruebe con otros más pequeños");
                }
               
                
                //else
                //{
                //    MessageBox.Show("Uno o más campos contienen números muy grandes. Intente con más pequeños");
                //}
...
static Random _Random = new Random();
        ...
        private void txtBoxDesde_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 8)
            {
                e.Handled = false;
            ...
            for (int i = 0; i < txtBoxDesde.Text.Length; i++)
            {
                if (txtBoxDesde.Text[i] == '.')
                    IsDec = true;
